...
namespace Dobot
{
    ...
    */
    ...
    std::string CDashboard::PositiveSolution(const CDescartesPoint &pt, int User, int Tool)
    {
        ...
        std::string str = "PositiveSolution(" + std::to_string(pt.x) + "," +
                          std::to_string(pt.y) + "," + std::to_string(pt.z) + "," +
                          std::to_string(pt.r) + "," + std::to_string(User) + "," + std::to_string(Tool) + ")";
        if (!SendData(str))
        {
            return str + ":send error";
        }
    ...
    std::string CDashboard::InverseSolution(const CDescartesPoint &pt, int User, int Tool)
    {
        ...
        std::string str = "InverseSolution(" + std::to_string(pt.x) + "," +
                          std::to_string(pt.y) + "," + std::to_string(pt.z) + "," +
                          std::to_string(pt.r) + "," + std::to_string(User) + "," + std::to_string(Tool) + ")";
        if (!SendData(str))
        {
